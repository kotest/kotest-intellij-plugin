...
/**
 * An implementation of [ServiceMessageParserCallback] that parses messages from the Kotest test runner
 * in team city format.
 */
...
interface KotestTestDescriptor : TestDescriptor {
   val testId: String
   val testType: String
...
data class TestCaseDescriptor(
   ...
   override fun getParent(): TestDescriptor = parentTestDescriptor
...
data class SpecDescriptor(
   ...
   override fun getClassName(): String = fqn
   override fun isComposite(): Boolean = true
   override fun getParent(): TestDescriptor = root
